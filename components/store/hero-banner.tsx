...
export default function HeroBanner() {
  ...
  const shellClass =
    "relative w-full max-w-[1920px] mx-auto overflow-hidden bg-secondary " +
    "min-h-[200px] max-h-[70vh] h-[clamp(200px,38vh,480px)] " +
    "sm:h-[clamp(220px,42vh,500px)] md:h-[clamp(240px,45vh,520px)]"

  const imgSizes = "(max-width: 1920px) 100vw, 1920px"

  if (!banners?.length) {
    return (
      <section className="w-full bg-secondary" aria-label="Destaque">
  ...
  return (
    <section className="w-full bg-secondary" aria-label="Banners">
      <div className={shellClass}>
